...
splaytree_t * splaytree_splay(splaytree_t *t, int i)
{
    splaytree_t N, *l, *r, *y;
...
splaytree_t * splaytree_insert(splaytree_t * t, int i, void *data)
{
...
/* Return a pointer to the resulting tree.                   */
    ...
    new = (splaytree_t *) malloc (sizeof (splaytree_t));
    assert(new);
    if (t == NULL) {
...
splaytree_t * splaytree_delete(splaytree_t *t, int i) {
...
#if 0
static splaytree_t *splaytree_find_rank(int r, splaytree_t *t) {
